<section class="mt-3 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
    ...
    <div class="flex flex-col justify-between rounded-[1.75rem] border border-stone-200 bg-white p-5 shadow-sm sm:col-span-2 lg:col-span-1">
