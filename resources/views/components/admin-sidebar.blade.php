...
<aside class="fixed inset-y-0 left-0 z-40 hidden border-r border-stone-200 bg-white md:block" style="width: var(--admin-sidebar-width);">
    <div class="flex h-full flex-col">
        ...
        <nav class="flex-1 space-y-1 overflow-y-auto px-4 py-6">
            <a href="{{ route('admin.dashboard') }}"
               class="flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition {{ request()->routeIs('admin.dashboard') ? 'border border-emerald-200 bg-emerald-50 text-emerald-700' : 'text-stone-700 hover:border-stone-200 hover:bg-stone-50' }}"
