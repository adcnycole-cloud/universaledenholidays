...
<div>
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td>10% of total booking value</td>
                </tr>
                <tr>
                    <td>15 – 30 days</td>
                    <td>30% of total booking value</td>
                </tr>
                <tr>
                    <td>7 – 14 days</td>
                    <td>50% of total booking value</td>
                </tr>
                <tr>
                    <td>Less than 7 days</td>
                    <td>100% of total booking value (no refund)</td>
                </tr>
            </tbody>
        </table>
    </div>
    <p>
        The above charges apply to standard tour packages. Transport-only bookings may have different cancellation
    ...
    <ul>
        <li>Approved refunds will be processed within <strong>14 working days</strong> of the cancellation
            confirmation.</li>
        <li>Refunds will be returned via the original payment method where possible.</li>
        <li>Processing fees charged by third-party payment providers are non-refundable.</li>
    ...
    <ul>
        ...
        <li>An alternative tour or travel date of equivalent value, subject to your agreement.</li>
    </ul>
    ...
    <p>
        ...
        offer a travel credit or rescheduled trip. Refunds in force majeure situations are subject to our
    ...
    <ul>
        ...
        <li>Entrance fees and permits paid to third-party authorities.</li>
